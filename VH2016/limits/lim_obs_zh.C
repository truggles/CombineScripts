void lim_obs_zh()
{
//=========Macro generated from canvas: lim_obs_zh/lim_obs_zh
//=========  (Thu Apr  5 17:47:58 2018) by ROOT version6.02/05
   TCanvas *lim_obs_zh = new TCanvas("lim_obs_zh", "lim_obs_zh",0,0,600,600);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   lim_obs_zh->SetHighLightColor(2);
   lim_obs_zh->Range(0,0,1,1);
   lim_obs_zh->SetFillColor(0);
   lim_obs_zh->SetBorderMode(0);
   lim_obs_zh->SetBorderSize(2);
   lim_obs_zh->SetLeftMargin(0.16);
   lim_obs_zh->SetRightMargin(0.04);
   lim_obs_zh->SetTopMargin(0.06);
   lim_obs_zh->SetBottomMargin(0.12);
   lim_obs_zh->SetFrameFillStyle(0);
   lim_obs_zh->SetFrameBorderMode(0);
  
// ------------>Primitives in pad: pad
   TPad *pad = new TPad("pad", "pad",0,0,1,1);
   pad->Draw();
   pad->cd();
   pad->Range(104,-2.09148,141.5,15.33752);
   pad->SetFillColor(0);
   pad->SetBorderMode(0);
   pad->SetBorderSize(2);
   pad->SetTickx(1);
   ...
   Graph_Graph3001->SetMinimum(0.1682349);
   Graph_Graph3001->SetMaximum(11.67798);
   ...
   Graph_Graph3002->SetMinimum(0.94105);
   Graph_Graph3002->SetMaximum(8.017865);
   ...
   Graph_Graph1->SetMinimum(1.925);
   Graph_Graph1->SetMaximum(5.2625);
   ...
   tmp0_copy3->SetMinimum(0.1682349);
   tmp0_copy3->SetMaximum(11.67798);
   ...
   tmp0_copy4->SetMinimum(0.1682349);
   tmp0_copy4->SetMaximum(11.67798);
...
tex->SetNDC();
   ...
   lim_obs_zh->Modified();
   lim_obs_zh->cd();
   lim_obs_zh->SetSelected(lim_obs_zh);
   lim_obs_zh->SaveAs("lim_obs_zh.pdf");
}
