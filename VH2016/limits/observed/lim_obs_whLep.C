void lim_obs_whLep()
{
//=========Macro generated from canvas: lim_obs_whLep/lim_obs_whLep
//=========  (Thu Apr  5 17:47:46 2018) by ROOT version6.02/05
   TCanvas *lim_obs_whLep = new TCanvas("lim_obs_whLep", "lim_obs_whLep",0,0,600,600);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   lim_obs_whLep->SetHighLightColor(2);
   lim_obs_whLep->Range(0,0,1,1);
   lim_obs_whLep->SetFillColor(0);
   lim_obs_whLep->SetBorderMode(0);
   lim_obs_whLep->SetBorderSize(2);
   lim_obs_whLep->SetLeftMargin(0.16);
   lim_obs_whLep->SetRightMargin(0.04);
   lim_obs_whLep->SetTopMargin(0.06);
   lim_obs_whLep->SetBottomMargin(0.12);
   lim_obs_whLep->SetFrameFillStyle(0);
   lim_obs_whLep->SetFrameBorderMode(0);
  
// ------------>Primitives in pad: pad
   TPad *pad = new TPad("pad", "pad",0,0,1,1);
   pad->Draw();
   pad->cd();
   pad->Range(104,-3.027319,141.5,22.20034);
   pad->SetFillColor(0);
   pad->SetBorderMode(0);
   pad->SetBorderSize(2);
   pad->SetTickx(1);
   ...
   Graph_Graph3001->SetMinimum(0.008264732);
   Graph_Graph3001->SetMaximum(16.92471);
   ...
   Graph_Graph3002->SetMinimum(1.016234);
   Graph_Graph3002->SetMaximum(11.95607);
   ...
   Graph_Graph1->SetMinimum(2.265625);
   Graph_Graph1->SetMaximum(8.078125);
   ...
   tmp0_copy3->SetMinimum(0.008264732);
   tmp0_copy3->SetMaximum(16.92471);
   ...
   tmp0_copy4->SetMinimum(0.008264732);
   tmp0_copy4->SetMaximum(16.92471);
...
tex->SetNDC();
   ...
   pad->Modified();
   lim_obs_whLep->cd();
   lim_obs_whLep->Modified();
   lim_obs_whLep->cd();
   lim_obs_whLep->SetSelected(lim_obs_whLep);
   lim_obs_whLep->SaveAs("lim_obs_whLep.pdf");
}
