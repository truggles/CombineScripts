void lim_obs_llmt()
{
//=========Macro generated from canvas: lim_obs_llmt/lim_obs_llmt
//=========  (Thu Apr  5 17:47:27 2018) by ROOT version6.02/05
   TCanvas *lim_obs_llmt = new TCanvas("lim_obs_llmt", "lim_obs_llmt",0,0,600,600);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   lim_obs_llmt->SetHighLightColor(2);
   lim_obs_llmt->Range(0,0,1,1);
   lim_obs_llmt->SetFillColor(0);
   lim_obs_llmt->SetBorderMode(0);
   lim_obs_llmt->SetBorderSize(2);
   lim_obs_llmt->SetLeftMargin(0.16);
   lim_obs_llmt->SetRightMargin(0.04);
   lim_obs_llmt->SetTopMargin(0.06);
   lim_obs_llmt->SetBottomMargin(0.12);
   lim_obs_llmt->SetFrameFillStyle(0);
   lim_obs_llmt->SetFrameBorderMode(0);
  
// ------------>Primitives in pad: pad
   TPad *pad = new TPad("pad", "pad",0,0,1,1);
   pad->Draw();
   pad->cd();
   pad->Range(104,-3.838226,141.5,28.14699);
   pad->SetFillColor(0);
   pad->SetBorderMode(0);
   pad->SetBorderSize(2);
   pad->SetTickx(1);
   ...
   Graph_Graph3001->SetMinimum(0.01108303);
   Graph_Graph3001->SetMaximum(21.45816);
   ...
   Graph_Graph3002->SetMinimum(1.411246);
   Graph_Graph3002->SetMaximum(14.27634);
   ...
   Graph_Graph1->SetMinimum(3.13125);
   Graph_Graph1->SetMaximum(9.05625);
   ...
   Graph_Graph2->SetMinimum(6.521627);
   Graph_Graph2->SetMaximum(11.92986);
   ...
   tmp0_copy3->SetMinimum(0.01108303);
   tmp0_copy3->SetMaximum(21.45816);
   ...
   tmp0_copy4->SetMinimum(0.01108303);
   tmp0_copy4->SetMaximum(21.45816);
...
tex->SetNDC();
   ...
   pad->Modified();
   lim_obs_llmt->cd();
   lim_obs_llmt->Modified();
   lim_obs_llmt->cd();
   lim_obs_llmt->SetSelected(lim_obs_llmt);
}
