void lim_obs_wh()
{
//=========Macro generated from canvas: lim_obs_wh/lim_obs_wh
//=========  (Thu Apr  5 17:48:05 2018) by ROOT version6.02/05
   TCanvas *lim_obs_wh = new TCanvas("lim_obs_wh", "lim_obs_wh",0,0,600,600);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   lim_obs_wh->SetHighLightColor(2);
   lim_obs_wh->Range(0,0,1,1);
   lim_obs_wh->SetFillColor(0);
   lim_obs_wh->SetBorderMode(0);
   lim_obs_wh->SetBorderSize(2);
   lim_obs_wh->SetLeftMargin(0.16);
   lim_obs_wh->SetRightMargin(0.04);
   lim_obs_wh->SetTopMargin(0.06);
   lim_obs_wh->SetBottomMargin(0.12);
   lim_obs_wh->SetFrameFillStyle(0);
   lim_obs_wh->SetFrameBorderMode(0);
...
// ------------>Primitives in pad: pad
   ...
   Graph_Graph3001->SetMinimum(0.177595);
   Graph_Graph3001->SetMaximum(10.4665);
   ...
   Graph_Graph3002->SetMinimum(0.8575415);
   Graph_Graph3002->SetMaximum(7.384151);
   ...
   Graph_Graph1->SetMinimum(1.721094);
   Graph_Graph1->SetMaximum(4.974219);
   ...
   tmp0_copy3->SetMinimum(0.177595);
   tmp0_copy3->SetMaximum(10.4665);
   ...
   tmp0_copy4->SetMinimum(0.177595);
   tmp0_copy4->SetMaximum(10.4665);
...
tex->SetNDC();
   ...
   lim_obs_wh->Modified();
   lim_obs_wh->cd();
   lim_obs_wh->SetSelected(lim_obs_wh);
}
