void lim_obs_wh_noToys()
{
//=========Macro generated from canvas: lim_obs_wh_noToys/lim_obs_wh_noToys
//=========  (Tue May 29 22:59:26 2018) by ROOT version6.02/05
   TCanvas *lim_obs_wh_noToys = new TCanvas("lim_obs_wh_noToys", "lim_obs_wh_noToys",0,0,600,600);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   lim_obs_wh_noToys->SetHighLightColor(2);
   lim_obs_wh_noToys->Range(0,0,1,1);
   lim_obs_wh_noToys->SetFillColor(0);
   lim_obs_wh_noToys->SetBorderMode(0);
   lim_obs_wh_noToys->SetBorderSize(2);
   lim_obs_wh_noToys->SetLeftMargin(0.16);
   lim_obs_wh_noToys->SetRightMargin(0.04);
   lim_obs_wh_noToys->SetTopMargin(0.06);
   lim_obs_wh_noToys->SetBottomMargin(0.12);
   lim_obs_wh_noToys->SetFrameFillStyle(0);
   lim_obs_wh_noToys->SetFrameBorderMode(0);
  
// ------------>Primitives in pad: pad
   TPad *pad = new TPad("pad", "pad",0,0,1,1);
   pad->Draw();
   pad->cd();
   pad->Range(104,-2.078126,141.5,15.23959);
   pad->SetFillColor(0);
   pad->SetBorderMode(0);
   pad->SetBorderSize(2);
   pad->SetTickx(1);
   ...
   Graph_Graph3001->SetMinimum(0.1527599);
   Graph_Graph3001->SetMaximum(10.73968);
   ...
   Graph_Graph3002->SetMinimum(0.8450438);
   Graph_Graph3002->SetMaximum(7.521625);
   ...
   Graph_Graph1->SetMinimum(1.716406);
   Graph_Graph1->SetMaximum(5.025781);
   ...
   Graph_Graph2->SetMinimum(4.006734);
   Graph_Graph2->SetMaximum(11.25437);
   ...
   tmp0_copy3->SetMinimum(0.1527599);
   tmp0_copy3->SetMaximum(10.73968);
   ...
   tmp0_copy4->SetMinimum(0.1527599);
   tmp0_copy4->SetMaximum(10.73968);
...
tex->SetNDC();
   ...
   tex->Draw();
   pad->Modified();
   lim_obs_wh_noToys->cd();
   lim_obs_wh_noToys->Modified();
   lim_obs_wh_noToys->cd();
   lim_obs_wh_noToys->SetSelected(lim_obs_wh_noToys);
}
