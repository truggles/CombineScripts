void lim_obs_whLep_noToys()
{
//=========Macro generated from canvas: lim_obs_whLep_noToys/lim_obs_whLep_noToys
//=========  (Tue May 29 22:59:36 2018) by ROOT version6.02/05
   TCanvas *lim_obs_whLep_noToys = new TCanvas("lim_obs_whLep_noToys", "lim_obs_whLep_noToys",0,0,600,600);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   lim_obs_whLep_noToys->SetHighLightColor(2);
   lim_obs_whLep_noToys->Range(0,0,1,1);
   lim_obs_whLep_noToys->SetFillColor(0);
   lim_obs_whLep_noToys->SetBorderMode(0);
   lim_obs_whLep_noToys->SetBorderSize(2);
   lim_obs_whLep_noToys->SetLeftMargin(0.16);
   lim_obs_whLep_noToys->SetRightMargin(0.04);
   lim_obs_whLep_noToys->SetTopMargin(0.06);
   lim_obs_whLep_noToys->SetBottomMargin(0.12);
   lim_obs_whLep_noToys->SetFrameFillStyle(0);
   lim_obs_whLep_noToys->SetFrameBorderMode(0);
  
// ------------>Primitives in pad: pad
   TPad *pad = new TPad("pad", "pad",0,0,1,1);
   pad->Draw();
   pad->cd();
   pad->Range(104,-3.049351,141.5,22.36191);
   pad->SetFillColor(0);
   pad->SetBorderMode(0);
   pad->SetBorderSize(2);
   pad->SetTickx(1);
   ...
   Graph_Graph3001->SetMaximum(17.05094);
   ...
   Graph_Graph3002->SetMinimum(0.9717993);
   Graph_Graph3002->SetMaximum(11.99313);
   ...
   Graph_Graph1->SetMinimum(2.222656);
   Graph_Graph1->SetMaximum(8.082031);
   ...
   Graph_Graph2->SetMinimum(5.615655);
   Graph_Graph2->SetMaximum(13.81724);
   ...
   tmp0_copy3->SetMaximum(17.05094);
   ...
   tmp0_copy4->SetMaximum(17.05094);
...
tex->SetNDC();
   ...
   tex->Draw();
   pad->Modified();
   lim_obs_whLep_noToys->cd();
   lim_obs_whLep_noToys->Modified();
   lim_obs_whLep_noToys->cd();
   lim_obs_whLep_noToys->SetSelected(lim_obs_whLep_noToys);
   lim_obs_whLep_noToys->SaveAs("lim_obs_whLep_noToys.pdf");
}
