void lim_obs_whHad_noToys()
{
//=========Macro generated from canvas: lim_obs_whHad_noToys/lim_obs_whHad_noToys
//=========  (Tue May 29 22:59:31 2018) by ROOT version6.02/05
   TCanvas *lim_obs_whHad_noToys = new TCanvas("lim_obs_whHad_noToys", "lim_obs_whHad_noToys",0,0,600,600);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   lim_obs_whHad_noToys->SetHighLightColor(2);
   lim_obs_whHad_noToys->Range(0,0,1,1);
   lim_obs_whHad_noToys->SetFillColor(0);
   lim_obs_whHad_noToys->SetBorderMode(0);
   lim_obs_whHad_noToys->SetBorderSize(2);
   lim_obs_whHad_noToys->SetLeftMargin(0.16);
   lim_obs_whHad_noToys->SetRightMargin(0.04);
   lim_obs_whHad_noToys->SetTopMargin(0.06);
   lim_obs_whHad_noToys->SetBottomMargin(0.12);
   lim_obs_whHad_noToys->SetFrameFillStyle(0);
   lim_obs_whHad_noToys->SetFrameBorderMode(0);
  
// ------------>Primitives in pad: pad
   TPad *pad = new TPad("pad", "pad",0,0,1,1);
   pad->Draw();
   pad->cd();
   pad->Range(104,-2.659031,141.5,19.49956);
   pad->SetFillColor(0);
   pad->SetBorderMode(0);
   pad->SetBorderSize(2);
   pad->SetTickx(1);
   ...
   Graph_Graph3001->SetMinimum(0.2828154);
   Graph_Graph3001->SetMaximum(14.84069);
   ...
   Graph_Graph3002->SetMinimum(1.309832);
   Graph_Graph3002->SetMaximum(10.17101);
   ...
   Graph_Graph1->SetMinimum(2.634375);
   Graph_Graph1->SetMaximum(6.646875);
   ...
   Graph_Graph2->SetMinimum(3.434806);
   Graph_Graph2->SetMaximum(13.43718);
   ...
   tmp0_copy3->SetMinimum(0.2828154);
   tmp0_copy3->SetMaximum(14.84069);
   ...
   tmp0_copy4->SetMinimum(0.2828154);
   tmp0_copy4->SetMaximum(14.84069);
...
tex->SetNDC();
   ...
   tex->Draw();
   pad->Modified();
   lim_obs_whHad_noToys->cd();
   lim_obs_whHad_noToys->Modified();
   lim_obs_whHad_noToys->cd();
   lim_obs_whHad_noToys->SetSelected(lim_obs_whHad_noToys);
   lim_obs_whHad_noToys->SaveAs("lim_obs_whHad_noToys.pdf");
}
