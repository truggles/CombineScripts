void lim_obs_llet()
{
//=========Macro generated from canvas: lim_obs_llet/lim_obs_llet
//=========  (Thu Apr  5 17:47:21 2018) by ROOT version6.02/05
   TCanvas *lim_obs_llet = new TCanvas("lim_obs_llet", "lim_obs_llet",0,0,600,600);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   lim_obs_llet->SetHighLightColor(2);
   lim_obs_llet->Range(0,0,1,1);
   lim_obs_llet->SetFillColor(0);
   lim_obs_llet->SetBorderMode(0);
   lim_obs_llet->SetBorderSize(2);
   lim_obs_llet->SetLeftMargin(0.16);
   lim_obs_llet->SetRightMargin(0.04);
   lim_obs_llet->SetTopMargin(0.06);
   lim_obs_llet->SetBottomMargin(0.12);
   lim_obs_llet->SetFrameFillStyle(0);
   lim_obs_llet->SetFrameBorderMode(0);
  
// ------------>Primitives in pad: pad
   TPad *pad = new TPad("pad", "pad",0,0,1,1);
   pad->Draw();
   pad->cd();
   pad->Range(104,-6.473441,141.5,47.4719);
   pad->SetFillColor(0);
   pad->SetBorderMode(0);
   pad->SetBorderSize(2);
   pad->SetTickx(1);
   ...
   Graph_Graph3001->SetMaximum(36.24331);
   ...
   Graph_Graph3002->SetMinimum(1.605953);
   Graph_Graph3002->SetMaximum(23.817);
   ...
   Graph_Graph1->SetMinimum(4.196875);
   Graph_Graph1->SetMaximum(14.95937);
   ...
   Graph_Graph2->SetMinimum(7.478452);
   Graph_Graph2->SetMaximum(31.94396);
   ...
   tmp0_copy3->SetMaximum(36.24331);
   ...
   tmp0_copy4->SetMaximum(36.24331);
...
tex->SetNDC();
   ...
   pad->Modified();
   lim_obs_llet->cd();
   lim_obs_llet->Modified();
   lim_obs_llet->cd();
   lim_obs_llet->SetSelected(lim_obs_llet);
}
