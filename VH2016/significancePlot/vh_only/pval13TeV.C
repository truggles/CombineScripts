...
//=========  (Fri Apr 27 15:13:32 2018) by ROOT version6.02/05
   ...
   Graph_Graph1->SetMinimum(0.0006582498);
   Graph_Graph1->SetMaximum(0.02929291);
   ...
   Graph_Graph2->SetMinimum(0.06306668);
   Graph_Graph2->SetMaximum(0.269603);
