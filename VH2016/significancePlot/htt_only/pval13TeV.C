...
//=========  (Fri Apr 27 15:26:30 2018) by ROOT version6.02/05
   TCanvas *c = new TCanvas("c", "c",597,1463,800,755);
   gStyle->SetOptStat(0);
   c->SetHighLightColor(2);
   c->Range(100,-8.661341,150,0.9623713);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetLogy();
   ...
   Graph_Graph1->SetMinimum(1.917056e-07);
   Graph_Graph1->SetMaximum(0.0001760318);
   ...
   Graph_Graph2->SetMinimum(3.375434e-06);
   Graph_Graph2->SetMaximum(0.0002651623);
